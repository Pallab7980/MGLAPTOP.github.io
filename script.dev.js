...
function list_open() {
  document.getElementById('share-list').style = "display:inline-flex"; // document.getElementById('over').style="overflow:hidden;";
}

function mark() {
  document.getElementById('share-list').style = "display:none"; // document.getElementById('over').style="overflow:none;";
}

function played() {
  var strech = document.querySelector(".inted");
...
;
var copy = document.getElementById("copy_link");
var text = document.getElementById("para");
copy.addEventListener('click', function () {
  navigator.clipboard.writeText(text.innerText);
});
var text1 = document.getElementById("para1");
var copy1 = document.getElementById("copy_link1");
copy1.addEventListener('click', function () {
  navigator.clipboard.writeText(text1.innerText);
});
var text2 = document.getElementById("para2");
var copy2 = document.getElementById("copy_link2");
copy2.addEventListener('click', function () {
  navigator.clipboard.writeText(text2.innerText);
});
var text3 = document.getElementById("para3");
var copy3 = document.getElementById("copy_link3");
...
function HOME() {
  var check = document.querySelectorAll(".menu a")[0];
...
function ABOUT() {
  var check1 = document.querySelectorAll(".menu a")[1];
...
function FAQ() {
  var check2 = document.querySelectorAll(".menu a")[2];
...
function toright() {
  var to = document.getElementById("sli");
  to.scrollBy(600, 0);
}

function toleft() {
  var to1 = document.getElementById("sli");
  to1.scrollBy(-600, 0);
}

var res = document.getElementById("spa");
respons = document.querySelector(".qs-ans-1 .text-tag");
res.addEventListener('click', function _callee() {
  var prom;
      ...
      switch (_context.prev = _context.next) {
        case 0:
          prom = new Promise(function (resolve) {
            var d = document.querySelector("#spa").style = " transition:0.3s; transform:rotate(100deg);opacity:0; z-index:-1  ";
            resolve(d);
          });
          _context.next = 3;
...
var res1 = document.getElementById("spa2");
...
var res2 = document.getElementById("spa1");
...
var res3 = document.getElementById("spa3");
...
var res4 = document.getElementById("spa4");
...
var res5 = document.getElementById("spa5");
respons5 = document.querySelector(".qs-ans-3 .text-tag");
res5.addEventListener('click', function () {
...
var res6 = document.getElementById("spa6");
respons6 = document.querySelector(".qs-ans-4 .text-tag");
res6.addEventListener('click', function () {
...
var res7 = document.getElementById("spa7");
respons7 = document.querySelector(".qs-ans-4 .text-tag");
res7.addEventListener('click', function () {
...
function blank() {
  var grr = document.getElementById("share-list");
  grr.style = "opacity:0; ";
